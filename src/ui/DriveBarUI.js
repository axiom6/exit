...
(function() {
  ...
  DriveBarUI = (function() {
    ...
    DriveBarUI.prototype.createBars = function(trip, Data) {
      ...
      this.rect(this.g, this.ext + 'Border', x, y, w, h, 'transparent', 'white', thick * 4, '');
      ref = trip.segments;
      for (key in ref) {
    ...
    DriveBarUI.prototype.rect = function(g, segId, x0, y0, w, h, fill, stroke, thick, text) {
      var onClick, svgId;
    ...
    DriveBarUI.prototype.doSeqmentDeals = function(segId, mile) {
      var deals, exit;
