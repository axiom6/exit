  ...
  Model = (function() {
    class Model {
      constructor(stream, rest, dataSource) {
        ...
        this.Data = Util.Import('app/Data'); // We occasionally need to key of some static data at this point of the project
        ...
        this.milePosts = [];
        this.segmentIds = this.Data.WestSegmentIds; // CDOT road speed segment for Demo I70 West from 6th Ave to East Vail
