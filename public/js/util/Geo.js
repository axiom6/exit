...
Geo = class Geo {
  constructor() {
    Util.noop(this.boundingBoxAroundPolyCoords, this.pnpoly, this.lineStringsIntersect, this.pointInPolygon);
    Util.noop(this.pointInMultiPolygon, this.drawCircle, this.rectangleCentroid, this.geometryWithinRadius);
    Util.noop(this.centroid, this.simplify, this.destinationPoint, Geo);
  }
