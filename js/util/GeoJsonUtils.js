...
(function() {
  ...
  GeoJsonUtils = (function() {
    function GeoJsonUtils() {}

    GeoJsonUtils.prototype.boundingBoxAroundPolyCoords = function(coords) {
      var i, xAll, yAll;
      xAll = [];
      yAll = [];
      i = 0;
    ...
    GeoJsonUtils.prototype.pnpoly = function(x, y, coords) {
    ...
    GeoJsonUtils.prototype.lineStringsIntersect = function(l1, l2) {
    ...
    GeoJsonUtils.prototype.pointInBoundingBox = function(point, bounds) {
      return !(point.coordinates[1] < bounds[0][0] || point.coordinates[1] > bounds[1][0] || point.coordinates[0] < bounds[0][1] || point.coordinates[0] > bounds[1][1]);
    };

    GeoJsonUtils.prototype.pointInPolygon = function(p, poly) {
    ...
    GeoJsonUtils.prototype.pointInMultiPolygon = function(p, poly) {
    ...
    GeoJsonUtils.prototype.numberToRadius = function(number) {
      return number * Math.PI / 180;
    };

    GeoJsonUtils.prototype.numberToDegree = function(number) {
      return number * 180 / Math.PI;
    };

    GeoJsonUtils.prototype.drawCircle = function(radiusInMeters, centerPoint, steps) {
    ...
    GeoJsonUtils.prototype.rectangleCentroid = function(rectangle) {
    ...
    GeoJsonUtils.prototype.pointDistance = function(pt1, pt2) {
    ...
    GeoJsonUtils.prototype.geometryWithinRadius = function(geometry, center, radius) {
    ...
    GeoJsonUtils.prototype.area = function(polygon) {
    ...
    GeoJsonUtils.prototype.centroid = function(polygon) {
    ...
    GeoJsonUtils.prototype.simplify = function(source, kink) {
    ...
    GeoJsonUtils.prototype.destinationPoint = function(pt, brng, dist) {
